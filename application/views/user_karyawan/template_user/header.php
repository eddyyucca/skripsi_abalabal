        ...
        <li class="nav-item">
          ...
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="<?= base_url('user_karyawan/data_pasangan') ?>">Data pasangan</a>
              <a class="collapse-item" href="<?= base_url('user_karyawan/data_anak') ?>">Data Anak</a>
              <a class="collapse-item" href="<?= base_url('user_karyawan/data_orangtua') ?>">Data Orang Tua</a>
              <a class="collapse-item" href="<?= base_url('user_karyawan/pendidikan') ?>">Riwayat Pendidikan</a>
              <a class="collapse-item" href="<?= base_url('user_karyawan/riwayat_pekerjaan') ?>">Riwayat Pekerjaan</a>
              <a class="collapse-item" href="<?= base_url('user_karyawan/pelatihan') ?>">Riwayat Pelatihan</a>
