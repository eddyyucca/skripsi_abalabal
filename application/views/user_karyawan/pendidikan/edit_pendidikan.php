                    ...
                    <form action="<?= base_url('user_karyawan/proseseditpendidikan/') . $pendidikan->id_pen ?>" method="POST">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="nama_sekolah" class="form-control" value="<?= $pendidikan->nama_sekolah ?>" required placeholder="Nama Sekolah">
                                </td>
                            </tr>
                            <tr>
                                <td width=20%>Jurusan</td>
                                <td>
                                    <input type="text" name="nama_jurusan" value="<?= $pendidikan->nama_jurusan ?>" class="form-control" required placeholder="Jurusan Sekolah">
                                </td>
                            </tr>
                            <tr>
                                <td width=20%>Nama Kota Pendidikan</td>
                                <td>
                                    <input type="text" name="kota_pendidikan" value="<?= $pendidikan->kota_pendidikan ?>" class="form-control" required placeholder="Kota Pendidikan">
                                </td>
                            </tr>
                            <tr>
