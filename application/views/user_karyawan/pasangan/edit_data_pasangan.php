                ...
                <div class="container">
                    ...
                    <table class="table">
                        <tr>
                            ...
                            <td><input type="text" name="nama_lengkap_pasangan" value="<?= $pasangan->nama_lengkap_pasangan ?>" class="form-control" required placeholder="Nama Lengkap"></td>
                        </tr>
                        <tr>
                            <td>Nama Panggilan</td>
                            <td><input type="text" name="nama_panggilan_pasangan" value="<?= $pasangan->nama_panggilan_pasangan ?>" class="form-control" required placeholder="Nama panggilan"></td>
                        </tr>

                        <tr>
                            <td>Tempat/Tanggal/Lahir</td>
                            <td><input type="text" name="tempat_pasangan" value="<?= $pasangan->tempat_pasangan ?>" class="form-control" required placeholder="Tempat">
                                <input type="date" name="ttl_pasangan" value="<?= $pasangan->ttl_pasangan ?>" class="form-control"></td>
                        </tr>
                        <tr>
                            <td>No KTP</td>
                            <td><input type="text" name="no_ktp_pasangan" value="<?= $pasangan->no_ktp_pasangan ?>" class="form-control" required placeholder="No KTP"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Telpon</td>
                            <td><input type="text" name="no_telp_pasangan" class="form-control" value="<?= $pasangan->telpon_pasangan ?>" required placeholder="Telpon"></td>
                        </tr>
                        <tr>
                            <td>Agama</td>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="warganegra_pasangan" value="<?= $pasangan->warganegra_pasangan ?>" class="form-control" required placeholder="kewarganegaraan"></td>
                        </tr>
                        <tr>
                            <td>Suku</td>
                            <td><input type="text" name="suku_pasangan" value="<?= $pasangan->suku_pasangan ?>" class="form-control" required placeholder="Suku"></td>
                        </tr>
                        <tr>
                            <td>
