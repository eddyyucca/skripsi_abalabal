                    ...
                    <form action="<?= base_url('user_karyawan/prosestambah_riwayatpendidikan') ?>" method="POST">
                        <table class="table">
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="nama_perusahaan" class="form-control" required placeholder="Nama Perusahaan">
                                </td>
                            </tr>
                            <tr>
                                <td width=20%>Bidang Usaha</td>
                                <td>
                                    <input type="text" name="bidang_usaha" class="form-control" required placeholder="Bidang Usaha">
                                </td>
                            </tr>
                            <tr>
                                <td width=20%>Jabatan Terakhir</td>
                                <td>
                                    <input type="text" name="jab_terakhir" class="form-control" required placeholder="Jabatan Terakhir">
                                </td>
                            </tr>
                            <tr>
                                <td width=20%>Gaji Terakhir</td>
                                <td>
                                    <input type="text" name="gaji_terakhir" class="form-control" required placeholder="Gaji Terakhir">
                                </td>
                            </tr>
                            <tr>
